            ...
            if name.startswith('.'):
                ...
                if (isinstance(md, dropbox.files.FileMetadata) and
                    ...
                    if mtime_dt > md.client_modified:
                        if yesno('Local copy is newer. Upload %s' % name, False, args):
                            upload(dbx, fullname, folder, subfolder, name,
                                   overwrite=True)                            
                    else:
                        if yesno('Dropbox copy is newer. Download %s' % name, False, args):
                            download(dbx, fullname, folder, subfolder, name)                           
...
def download(dbx, fullname, folder, subfolder, name):
    """Download a file.
    ...
    with stopwatch('download'):
        try:
            ...
            dbx.files_download_to_file(name, path)
